...
namespace NeinLinq
{
    ...
    public abstract class RewriteQuery : IOrderedQueryable, IDbAsyncEnumerable
    {
    ...
    /// </summary>
    [SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix")]
    public class RewriteQuery<T> : RewriteQuery, IOrderedQueryable<T>, IDbAsyncEnumerable<T>
    {
