...
namespace NeinLinq
{
    ...
    /// </summary>
    public static class DynamicAsyncQuery
    {
        /// <summary>
        ...
        internal static Expression CreateAsyncOrderClause(ParameterExpression target, Expression expression, string selector, string method)
        {
        ...
        internal static Expression CreateAsyncWhereClause(ParameterExpression target, Expression expression, string selector, DynamicCompare comparer, string value)
        {
        ...
        internal static Expression CreateAsyncWhereClause(ParameterExpression target, Expression expression, string selector, string comparer, string value)
        {
            var predicate = Expression.Lambda(DynamicQuery.CreateComparison(target, selector, comparer, value), target);
